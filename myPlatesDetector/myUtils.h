    ...
    public:
        ...
        )
        {
                  ...
                  (free_ramspace_img_MB > 0 && ((free_ramspace_img_MB * train_testing_ratio) / IMAGE_SIZEOF_MB) >= 1))
            {
                ...
                load_image_dataset_subset(images_train, boxes_train, imageDatasetFileTraining, imageLoadedCount_train, imageLoadedCount_train + trainToLoadCount);
                load_image_dataset_subset(images_test,  boxes_test,  imageDatasetFileTesting, imageLoadedCount_test, imageLoadedCount_test + testToLoadCount);
            ...
            pointerImgTrainStart = (pointerImgTrainStart + imageLoadedCount_train) % trainingSetSize;
            pointerImgTestStart = (pointerImgTestStart + imageLoadedCount_test) % testingSetSize;

        }


        bool getIsRamForAllImages(){
