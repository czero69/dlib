...
namespace {
    constexpr int class_count = 29; // background + 19 classes
    ...
    const std::vector<Voc2012class> classes = {
        ...
        Voc2012class(1, dlib::rgb_pixel(0, 0, 128 ), "bicycle"),
        Voc2012class(2, dlib::rgb_pixel(0, 0, 64 ), "bottle"),
        Voc2012class(3, dlib::rgb_pixel(0, 0, 192 ), "bus"),
        Voc2012class(4, dlib::rgb_pixel(0, 128, 0 ), "car"),
        Voc2012class(5, dlib::rgb_pixel(0, 128, 128 ), "cat"),
        Voc2012class(6, dlib::rgb_pixel(0, 128, 64 ), "chair"),
        Voc2012class(7, dlib::rgb_pixel(0, 128, 192 ), "dog"),
        Voc2012class(8, dlib::rgb_pixel(0, 64, 0 ), "motorcycle"),
        Voc2012class(9, dlib::rgb_pixel(0, 64, 128 ), "person"),
        Voc2012class(10, dlib::rgb_pixel(0, 64, 64 ), "potted plant"),
        Voc2012class(11, dlib::rgb_pixel(0, 64, 192 ), "bed"),
        Voc2012class(12, dlib::rgb_pixel(0, 192, 0 ), "tv"),
        Voc2012class(13, dlib::rgb_pixel(0, 192, 128 ), "handbag"),
        Voc2012class(14, dlib::rgb_pixel(0, 192, 64 ), "suitcase"),
        Voc2012class(15, dlib::rgb_pixel(0, 192, 192 ), "laptop"),
        Voc2012class(16, dlib::rgb_pixel(128, 0, 0 ), "pillow"),
        Voc2012class(17, dlib::rgb_pixel(128, 0, 128 ), "cardboard"),
        Voc2012class(18, dlib::rgb_pixel(128, 0, 64 ), "backpack"),
        Voc2012class(19, dlib::rgb_pixel(128, 0, 192 ), "hat"),
        Voc2012class(20, dlib::rgb_pixel(128, 128, 0 ), "truck"),
        Voc2012class(21, dlib::rgb_pixel(128, 128, 128 ), "train"),
        Voc2012class(22, dlib::rgb_pixel(128, 128, 64 ), "remote"),
        Voc2012class(23, dlib::rgb_pixel(128, 128, 192 ), "keyboard"),
        Voc2012class(24, dlib::rgb_pixel(128, 64, 0 ), "cell phone"),
        Voc2012class(25, dlib::rgb_pixel(128, 64, 128 ), "microwave"),
        Voc2012class(26, dlib::rgb_pixel(128, 64, 64 ), "toaster"),
        Voc2012class(27, dlib::rgb_pixel(128, 64, 192 ), "book"),
        Voc2012class(28, dlib::rgb_pixel(128, 192, 0 ), "vase"),
...
using net_type = dlib::loss_multiclass_log_per_pixel<
                            ...
                            dlib::input<std::array<dlib::matrix<dlib::rgb_pixel>,2>>
                            >>>>>>>>>>>>>>;

// ohter way worth to try is concatenate two rgb inputs as new tensor, there is concat2 class in dlib.
//dlib::concat2< dlib::tag2<dlib::input<dlib::matrix<dlib::rgb_pixel>>>, dlib::tag1<dlib::input<dlib::matrix<dlib::rgb_pixel, SUBNET>>>>
